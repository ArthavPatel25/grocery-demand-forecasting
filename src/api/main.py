...
def create_simple_features(request: PredictionRequest):
    ...
    chain_factors = {'Loblaws': 1.3, 'Metro': 1.1, 'Sobeys': 1.0, 'FreshCo': 0.8, 'No Frills': 0.7}
    province_factors = {'ON': 1.2, 'QC': 1.0, 'BC': 1.1, 'AB': 0.9, 'MB': 0.8, 'SK': 0.7, 'NS': 0.8, 'NB': 0.7, 'NL': 0.6, 'PE': 0.5}

    base_value = 15 * chain_factors.get(request.chain, 1.0) * province_factors.get(request.province, 1.0)
